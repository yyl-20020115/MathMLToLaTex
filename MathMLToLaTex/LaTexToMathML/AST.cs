...
public abstract class Node
{
    ...
    public class Under(Node n0, Node n1) : Node { public readonly Node n0 = n0; public readonly Node n1 = n1; }
    ...
    public class Sqrt(Node n0, Node n1) : Node { public readonly Node n0 = n0; public readonly Node n1 = n1; }
    ...
    public class Fenced(string open, string close, string content) : Node { public readonly string open = open; public readonly string close = close; public readonly string content = content; }
